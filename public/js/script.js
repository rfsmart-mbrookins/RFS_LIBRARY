...
const fetchData = async (url, params = "") => {
  try {
    ...
    document.getElementById("results").innerHTML =
      "<p>Error occurred. Please retry.</p>";
    throw error;
  } finally {
...
const createColumnFunctions = (columns) =>
  columns.map((col) => (item) => col(item));
...
const handleAddEmployeeSubmit = async (e) => {
  ...
  const newEmployee = {
    ...
    is_rf_smart_employee:
      document.getElementById("employeeRFSmartStatus").value === "true",
...
const setupAddEmployeeEventListeners = () => {
  document
    .getElementById("addReaderDonor")
    .addEventListener("click", showAddEmployeeForm);
  document
    .getElementById("cancelAddEmployee")
    .addEventListener("click", hideAddEmployeeForm);
  document
    .getElementById("addEmployeeForm")
    .addEventListener("submit", handleAddEmployeeSubmit);
};
...
const setupAddBookEventListeners = () => {
  ...
  document
    ...
    .addEventListener("click", hideAddBookForm);
  document
